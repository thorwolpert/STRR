...
def mock_gcp_storage():
    ...
    """
    with patch("strr_test_utils.db_fixtures.GCPStorageService", autospec=True) as mock_service:
...
def mock_gcp_queue():
    ...
    """
    with patch("strr_test_utils.db_fixtures.gcp_queue_publisher", autospec=True) as mock_pub:
        yield mock_pub