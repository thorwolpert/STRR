...
<template>
  <div class="connect-date-picker" :class="{ 'connect-date-picker__err': error }">
    <VueDatePicker
      v-model="selectedDate"
      auto-apply
      :action-row="{ showCancel: false, showNow: false, showPreview: false, showSelect: false }"
      calendar-cell-class-name="connect-date-picker__calendar__day"
      calendar-class-name="connect-date-picker__calendar"
