...
CONFIGURATION = {
    "development": "registration_expiry.config.DevConfig",
    "unittest": "registration_expiry.config.UnitTestConfig",
    "test": "registration_expiry.config.TestConfig",
    "production": "registration_expiry.config.ProdConfig",
    "default": "registration_expiry.config.ProdConfig",
}
