...
CONFIGURATION = {
    "development": "provisional_approval.config.DevConfig",
    "unittest": "provisional_approval.config.UnitTestConfig",
    "test": "provisional_approval.config.TestConfig",
    "production": "provisional_approval.config.ProdConfig",
    "default": "provisional_approval.config.ProdConfig",
}
