    ...
    test('Complete Application Flow', async ({ page }) => {
      ...
      await completeStep1(
        ...
        async () => {
          ...
          await page.getByRole('checkbox', { name: i18nText.text.businessLicNotRequired }).click()
          await page.getByRole('radio', { name: i18nText.label.blExemptionReasonOver30 }).click()
        }
      )
